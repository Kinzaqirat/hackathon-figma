...
export default function About2() {
  return (
    <div>
        {/* Text Section */}
        <div>
            <h1 className="sm:text-4xl text-2xl font-bold capitalize m-5 text-center">why choose us</h1>
...
<br />
      ...
      <div className="flex justify-evenly gap-x-6 gap-y-12 divide-x divide-gray-300 max-sm:block">
       ...
       <div className="flex justify-center"> <Image src={icon1} alt="" height={80} width={80}></Image></div>
          <h3 className="text-2xl font-extrabold mt-5 text-white">Best Chef</h3>
